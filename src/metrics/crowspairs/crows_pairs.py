...
Based on the work done in CrowS-Pairs: A Challenge Dataset for Measuring Social Biases in Masked Language Models
...
You can find the original repository at https://github.com/nyu-mll/crows-pairs/tree/master

The get_results() function was created using existing code from the original repo to return the metrics to our custom Metrics class.
...
def get_results(input_file,output_file,model,tokenizer,lm_model='bert'):
    """
