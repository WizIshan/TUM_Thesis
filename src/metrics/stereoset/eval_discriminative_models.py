...
You can find the original repository at https://github.com/moinnadeem/StereoSet/tree/master
...
def parse_args():
    ...
    pretrained_model_choices = ['bert-base-uncased','bert-base-cased', 'roberta-base']
    ...
    parser.add_argument("--skip-intersentence",
                        default=True, action="store_true", help="Skip intersentence evaluation.")
